...
class OneTemplate:
    ...
    def update(self, template_id: int, template: str, update_type: int) -> int:
        """Replaces the template contents"""
        return self._one_template.update(template_id, template, update_type)
    ...
    def chown(self, template_id: int, user_id: int, group_id: int) -> int:
    ...
    def lock(self, template_id: int, lock_level: int, check_already_locked: bool) -> int:
        """Locks a Template"""

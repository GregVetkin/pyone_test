...
class OneVmpool:
    ...
    def info(self, filter_flag: int, start_id: int, end_id: int, vm_state_filter: int, key_value_filter: str) -> VM_POOLSub:
    ...
    def infoextended(self, filter_flag: int, start_id: int, end_id: int, vm_state_filter: int, key_value_filter: str) -> VM_POOLSub:
        """Retrieves information for all or part of the VMs in the pool"""
        return self._one_vmpool.infoextended(filter_flag, start_id, end_id, vm_state_filter, key_value_filter)
    
    def infoset(self, vm_set: str, extended: bool) -> VM_POOLSub:
    ...
    def accounting(self, filter_flag: int, start_id: int, end_id: int) -> str:
        """Returns the virtual machine history records"""
        return self._one_vmpool.accounting(filter_flag, start_id, end_id)
    
    def showback(self, filter_flag: int, first_month: int, first_year: int, last_month: int, last_year: int) -> str:
    ...
    def calculateshowback(self, first_month: int, first_year: int, last_month: int, last_year: int) -> str:
